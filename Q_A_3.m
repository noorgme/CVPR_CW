...
normal_force = normal_data.sensor_matrices_force(:, (pap_number * 3) + 1 : ((pap_number * 3) + 2) + 1);
TPU_force = TPU_data.sensor_matrices_force(:, (pap_number * 3) + 1 : ((pap_number * 3) + 2) + 1);
rubber_force = rubber_data.sensor_matrices_force(:, (pap_number * 3) + 1 : ((pap_number * 3) + 2) + 1);
...
corner_normal_force = normal_data.sensor_matrices_force(:, (corner_pap_number * 3) + 1 : ((corner_pap_number * 3) + 2) + 1);
corner_TPU_force = TPU_data.sensor_matrices_force(:, (corner_pap_number * 3) + 1 : ((corner_pap_number * 3) + 2) + 1);
corner_rubber_force = rubber_data.sensor_matrices_force(:, (corner_pap_number * 3) + 1 : ((corner_pap_number * 3) + 2) + 1);
